 ...
 */
final class Version20220322162051 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE managers ADD roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', DROP hotel_id, DROP name, DROP lastname, CHANGE email email VARCHAR(180) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE managers ADD hotel_id INT NOT NULL, ADD name VARCHAR(255) NOT NULL, ADD lastname VARCHAR(255) NOT NULL, DROP roles, CHANGE email email VARCHAR(255) NOT NULL');
