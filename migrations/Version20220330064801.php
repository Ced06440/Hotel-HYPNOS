 ...
 */
final class Version20220330064801 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE booking CHANGE room_id rooms_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE booking CHANGE rooms_id room_id INT NOT NULL');
